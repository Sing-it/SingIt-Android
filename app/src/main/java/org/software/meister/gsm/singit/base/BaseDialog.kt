...
import org.software.meister.gsm.singit.widget.SingleLiveEvent
import org.software.meister.gsm.singit.BR

abstract class BaseDialog <VB : ViewDataBinding, VM : BaseViewModel>(@LayoutRes private val resource: Int) : DialogFragment() {
